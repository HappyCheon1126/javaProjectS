...
<div class="text-center card-hover" id="accordion">
  ...
  <div class="card">
    ...
    <div id="collapse3" class="collapse" data-parent="#accordion">
      ...
      <div class="card-body p-1"><a href="${ctp}/schedule/adminSchedule" target="adminContent">일정현황조회</a></div>
    </div>
  </div>
  <div class="card">
    <div class="card-header bg-warning p-2">
    ...
    <div id="collapse4" class="collapse" data-parent="#accordion">
      ...
      <div class="card-body p-1"><a href="${ctp}/dbShop/adminOrderStatus" target="adminContent">주문관리</a></div>
